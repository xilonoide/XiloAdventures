...
/// <summary>
/// Resultado de ejecutar un script manualmente.
/// </summary>
public class ScriptExecutionResult
{
    /// <summary>Indica si el script se ejecutó sin errores.</summary>
    public bool Success { get; set; }

    /// <summary>Mensajes generados durante la ejecución.</summary>
    public List<string> Messages { get; set; } = new();

    /// <summary>Mensaje de error si la ejecución falló.</summary>
